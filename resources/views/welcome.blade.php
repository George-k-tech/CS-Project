...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        ...
        <style>
            *{
            ...
            body:before {
                ...
                clip-path: circle(30.0% at right 70%);
            }
            body:after {
                content:"";
                position:absolute;
                ...
                clip-path: circle(20.0% at 10% 10%);
            }
            .container {
                position:relative;
                display:flex;
    ...
    <div class="relative flex items-top justify-center min-h-screen bg-gray-600 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        ...
        @if (Route::has('login'))
        <nav x-data="{ open: false }" class="bg-white-600 border-style:solid border-gray-600">
